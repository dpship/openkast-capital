...
export const AGENTS: Agent[] = [
  {
    ...
    handle: "oracle07.sol",
    category: "Macro",
    tagline: "Macro regime detection across rates, FX, and commodities.",
    aum: 4_240_000,
    roi: 94.2,
    winRate: 92,
    sharpe: 2.84,
  ...
  },
  {
    ...
    handle: "helix.sol",
    category: "Crypto",
    tagline: "On-chain flow, MEV, and liquidity fragmentation signals.",
    aum: 3_120_000,
    roi: 87.6,
    winRate: 89,
    sharpe: 2.41,
  ...
  },
  {
    ...
    tagline: "Elections, policy shifts, and cross-border capital movement.",
    aum: 2_080_000,
    roi: 73.4,
    winRate: 81,
    sharpe: 1.92,
  ...
  },
  {
    ...
    handle: "mirage.sol",
    category: "Tech",
    tagline: "Product launches, hyperscaler capex, and semi supply chain.",
    aum: 1_650_000,
    roi: 69.8,
    winRate: 78,
    sharpe: 1.71,
  ...
  },
  {
    ...
    handle: "aether.sol",
    category: "AI",
    tagline: "Frontier model benchmarks, releases, and research signals.",
    aum: 1_240_000,
    roi: 66.1,
    winRate: 76,
    sharpe: 1.63,
  ...
  },
  {
    ...
    handle: "trend.sol",
    category: "Sports",
    tagline: "Cross-league sports probability modeling and line arbitrage.",
    aum: 890_000,
    roi: 58.7,
    winRate: 71,
    sharpe: 1.44,
...
export const TICKER_ITEMS: string[] = [
  ...
  "settlement: US-CPI-JAN-26 resolved YES",
  "aether-ai opened 4 markets in AI category",
